 ...
 useEffect(() => {
  ...
  return TimerResponse &&(<button onClick={() => { changeName('subscription') ; toggle() }} className="sub-icon w-full rounded-md">
      <div className="flex gap-2 items-center">
        ...
        <div className="flex gap-4 items-center text-white"> الاشتراك  {TimerResponse.subscription_status != "غير مفعلة" ? <BiBoltCircle size={20} color="green" /> : <BiBoltCircle size={20} color="red" />}</div> 
       </div>
